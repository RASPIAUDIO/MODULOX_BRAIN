...
void codec_setup()
{
  ...
  // Set pga volumes
  codec.setLINVOLDB(20.00); // Valid options are -17.25dB to +30dB (0.75dB steps)
  codec.setRINVOLDB(20.00); // Valid options are -17.25dB to +30dB (0.75dB steps)
